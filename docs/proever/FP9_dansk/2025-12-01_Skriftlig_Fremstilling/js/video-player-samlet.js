...
(function (VideoPlayer, $, undefined) {
    ...
    var ResizeVideos = function () {
        $("video:visible").each(function () {
            ...
            var parent = videoElement.data("parent");

            // Check if parent is defined and is a valid jQuery object
            if (parent && parent.length) {
                ...
                // Ensure ".subtitles" exists before trying to access its children
                var subtitles = parent.children(".subtitles");
                if (subtitles.length) {
                    subtitles.children("p").css({
                        "font-size": fontSize + "px"
                    });
                }
            }
