document.addEventListener("DOMContentLoaded", function () {
    ...
    if (browser.name === "IE" || // Show popup for all versions of IE
        !supportedBrowsers.includes(browser.name) ||
        (browser.name === "Chrome" && parseInt(browser.version) < 125) ||
        (browser.name === "Firefox" && parseInt(browser.version) < 127) ||
        (browser.name === "Edge" && parseInt(browser.version) < 125) ||
